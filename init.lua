...
-- Disable language-host providers we never use (silences :checkhealth warnings
-- about missing `neovim` npm/gem/cpan packages). Re-enable individually if you
-- ever need :python3, :ruby, :perl, or remote-plugin support.

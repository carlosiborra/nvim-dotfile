...
return {
    ...
    require("dropbar").setup({
      bar = {
        enable = function(buf, win)
          ...
          local skip = { "TelescopePrompt", "neo-tree", "NvimTree", "alpha", "snacks_dashboard",
                         "lazy", "mason", "trouble", "DressingInput", "dapui_scopes",
                         "dapui_breakpoints", "dapui_stacks", "dapui_watches", "dapui_console",
                         "aerial", "noice", "copilot-chat", "codecompanion", "spectre_panel" }
  ...
  keys = {
    { "<leader>bb", function() require("dropbar.api").pick() end, desc = "Breadcrumbs: pick segment" },
  },
}

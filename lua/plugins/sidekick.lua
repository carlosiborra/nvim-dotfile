...
return {
  ...
  keys = {
    ...
    -- AI hub
    { "<leader>aa", function() require("sidekick.cli").toggle()                          end, desc = "Sidekick: toggle last" },
    { "<leader>af", function() require("sidekick.cli").focus()                           end, desc = "Sidekick: focus" },
    { "<leader>ap", function() require("sidekick.cli").prompt()                          end, desc = "Sidekick: prompt picker" },
    { "<leader>aP", function() require("sidekick.cli").select()                          end, desc = "Sidekick: pick CLI" },
    { "<leader>ac", function() require("sidekick.cli").toggle({ name = "claude" })       end, desc = "Sidekick: Claude Code" },
    { "<leader>ax", function() require("sidekick.cli").toggle({ name = "codex" })        end, desc = "Sidekick: Codex" },
    { "<leader>ao", function() require("sidekick.cli").toggle({ name = "opencode" })     end, desc = "Sidekick: OpenCode" },
    { "<leader>ag", function() require("sidekick.cli").toggle({ name = "copilot" })      end, desc = "Sidekick: gh copilot" },
